...
python task1.py infer --test_data_file /tcdata/final_test.json --test_table_file /tcdata/final_test.tables.json --model_weights ../model/task1.12-0.852.h5 --batch_size 256 --output_file ../task1_output.json
